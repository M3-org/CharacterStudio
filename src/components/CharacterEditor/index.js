...
export default function CharacterEditor(props) {
    ...
    return (_jsxs(React.Fragment, { children: [loadingModel && _jsx(LoadingOverlayCircularStatic, {}), _jsx(RandomizeButton, {}), _jsx(DownloadCharacter, {}), _jsx(Web3ReactProvider, { getLibrary: getLibrary, children: _jsx(ConnectMint, {}) }), _jsx(Scene, { editor: "generator", wrapClass: "generator" })] }));
}
