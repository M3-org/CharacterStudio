...
//	------------------------------------------------------------------------------
	...
	GLTFExporter.prototype = {
			 ...
			 *            options options
			 */
			parse: function ( input, vrmExt, model , onDone, options ) {
				...
				function processMaterial( material ) {
					...
					if ( material.isMeshBasicMaterial ) {						gltfMaterial.extensions = { KHR_materials_unlit: {} };
